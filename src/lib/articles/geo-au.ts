...
export const auArticles: Article[] = [
  {
    slug: "best-luxury-watches-buy-australia-2026",
    title: "Best Luxury Watches to Buy in Australia 2026 — Prices, ADs & Grey Market Guide",
    excerpt:
    ...
    type: "buying-guide",
    keywords: [
      "buy luxury watch australia",
      "best watch dealer sydney",
      "watch prices australia vs overseas",
      "jomashop shipping to australia",
      "grey market watches australia",
    ],
    ...
    products: [
      {
        name: "Tudor Black Bay 58 (Australia Price)",
      ...
      {
        name: "Omega Seamaster 300M (Australia Price)",
      ...
      {
        name: "Seiko Prospex SPB143 (Australia Price)",
...
This guide covers all your options so you can make the smartest purchase for your situation.`,
      ...
      {
        heading: "Where to Buy: Australian Authorized Dealers",
        body: `**Kennedy (Sydney, Melbourne, Brisbane)** — Australia's premier luxury watch retailer. Authorized dealer for Rolex, Tudor, Omega, Cartier, IWC, Panerai, Breitling, and more. The Collins Street Melbourne boutique is world-class. Kennedy is where you build a purchase history for waitlisted pieces.
...
**Online (Australian):** Watch Direct, Swiss Watch Direct — authorized dealers with online presence and Australian warranty. Competitive pricing but verify AD status before purchasing.`,
      ...
      {
        heading: "Grey Market & Overseas Buying: The Real Math",
        body: `**Jomashop (US grey market):** Typically 15-25% below Australian retail. Ships to Australia for ~$30-50. **The catch:** No manufacturer warranty — Jomashop provides their own warranty, which most Australian watchmakers won't honour. If your $4,000 watch needs a $500 service, you're sending it to the US.
...
**The honest recommendation:** For watches under AUD 3,000, buy Australian — the warranty and convenience justify the GST. For watches over AUD 5,000, the grey market savings of $750-$1,500 are significant — but understand the warranty trade-off. For watches over AUD 10,000, buy from an Australian AD and build a relationship — it matters for Rolex and Patek allocations.`,
      ...
      {
        heading: "Best Watches for the Australian Lifestyle",
        body: `Australia's climate and culture favor different watches than Europe:
...
**For summer specifically:** Australia's summer (December-February) demands watches that handle heat, water, and UV. Avoid leather straps (they rot in humidity). Steel bracelets, rubber, and NATO straps are your friends.`,
      ...
      {
        heading: "The Australian Watch Community",
        body: `**Watch forums:** Australian Watch Forum (australianwatchforum.com.au) is the local community — buy/sell, meet-ups, and AD reviews. OzBargain occasionally surfaces watch deals.
...
**Servicing:** Omega, Rolex, and Cartier all have Australian service centres. Independent watchmakers like Greg Brockhurst (Melbourne) and Peter Dix (Sydney) handle other brands. For grey market purchases, independent watchmakers are your service solution.`,
    ...
    faq: [
      {
        question: "Do I have to pay GST on watches bought overseas?",
        answer:
          "Technically yes — Australian customs applies 5% duty + 10% GST on goods valued over AUD 1,000. If you declare a watch bought overseas, you'll pay approximately 15% of its value. Undeclaring is illegal and risks seizure and fines. Many travelers take this risk; we can't recommend it.",
      },
      {
        question: "Is Jomashop safe to buy from in Australia?",
        answer:
          "Jomashop is a legitimate US retailer selling genuine watches. They ship to Australia reliably. The main risk isn't authenticity — it's warranty. Jomashop provides their own warranty, not the manufacturer's. Australian brand service centres typically won't honour Jomashop warranties for free.",
      },
      {
        question: "Which Australian city has the best watch shopping?",
        answer:
          "Melbourne — Kennedy's Collins Street boutique and Monards provide the best AD experience in Australia. Sydney has more brand boutiques (Omega, Rolex) and J Farren-Price. Brisbane is growing with Kennedy's expansion. Perth and Adelaide have limited but improving AD presence.",
      },
      {
        question: "Can I negotiate watch prices at Australian ADs?",
        answer:
          "Some flexibility exists at independent ADs (Monards, J Farren-Price). Large chains (Kennedy, Watches of Switzerland) rarely discount current models but may offer value-adds (straps, accessories). Pre-owned pieces and outgoing models have more negotiation room. Building a purchase relationship over time gives you better access and occasionally better pricing.",
      },
    ],
  },
];
